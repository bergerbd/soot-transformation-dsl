 ...
 * <ul>
 *   <li>{@link soot.jimple.toolkits.transformation.dsl.transformationLanguage.impl.DimensionImpl#getSize <em>Size</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DimensionImpl extends MinimalEObjectImpl.Container implements Dimension
{
  ...
  {
    return TransformationLanguagePackage.Literals.DIMENSION;
  }
  ...
  public void setSize(int newSize)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TransformationLanguagePackage.DIMENSION__SIZE, oldSize, size));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TransformationLanguagePackage.DIMENSION__SIZE:
        return getSize();
    }
