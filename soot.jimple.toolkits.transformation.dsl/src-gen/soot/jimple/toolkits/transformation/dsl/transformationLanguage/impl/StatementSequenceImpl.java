 ...
 * <ul>
 *   <li>{@link soot.jimple.toolkits.transformation.dsl.transformationLanguage.impl.StatementSequenceImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StatementSequenceImpl extends MinimalEObjectImpl.Container implements StatementSequence
{
  ...
  {
    return TransformationLanguagePackage.Literals.STATEMENT_SEQUENCE;
  }
  ...
  public EList<LabelOrStatement> getStatements()
  {
    if (statements == null)
    {
      statements = new EObjectContainmentEList<LabelOrStatement>(LabelOrStatement.class, this, TransformationLanguagePackage.STATEMENT_SEQUENCE__STATEMENTS);
    }
    return statements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TransformationLanguagePackage.STATEMENT_SEQUENCE__STATEMENTS:
