...
:
(
{ before(grammarAccess.getClassConstantAccess().getNameQualifiedNameParserRuleCall_1_0()); }
	ruleQualifiedName{ after(grammarAccess.getClassConstantAccess().getNameQualifiedNameParserRuleCall_1_0()); }
)
